...
{
    /// <summary>
    /// CompanyLocationController is the MVC Controller class for managing CompanyLocations in the UI
    /// </summary>
    [DnnHandleError]
    public class UniversalSettingsController : DnnController
    {
        ...
        /// </summary>
        public UniversalSettingsController() : this(CompanyLocationRepository.Instance) { }

        /// <summary>
        /// Constructor constructs a new CompanyLocationController with a passed in repository
        /// </summary>
        public UniversalSettingsController(ICompanyLocationRepository repository)
        {
        ...
        /// <summary>
        /// The Delete method is used to delete a CompanyLocation
        /// </summary>
        ...
        {
            var CompanyLocation = _repository.GetCompanyLocation(CompanyLocationId, PortalSettings.PortalId);
